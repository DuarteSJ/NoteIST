...
def create_document(document: DocumentModel, crud: DocumentCRUD = Depends(get_document_crud)):
...
def update_document(document_id: str, document: DocumentModel, crud: DocumentCRUD = Depends(get_document_crud)):
