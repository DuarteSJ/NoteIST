...
def load_key_from_file(key_file: str) -> str:
    ...
    try:
        ...
        print(f"Failed to load key from file {key_file}: {e}")
        sys.exit(1)
...
def main() -> int:
    ...
    protect_parser.add_argument('key_file', help='Path to the key file used to protect the file')
    ...
    unprotect_parser.add_argument('key_file', help='Path to the key file used to decrypt the file')
